...
# Реквизиты CRM (MS SQL) — одни и те же для всех компаний/скриптов.
CRM_DB = {
    'server':   'DBSRV',
    'database': 'crm',
...
# Полное название (рус/каз) и телефон компании — доступны в тексте письма
# как {{компания_ru}} / {{компания_kz}} / {{телефон}}, чтобы один шаблон
# письма подходил всем компаниям.
MAILING_SIGNATURE = {
    '1': {
        'full_name_ru': 'ТОО «...»',
        'full_name_kz': '«...» ЖШС',
